...
char *calc(char *str, int checkSumSize);

int main(void)
{

	//printf("\n--%s--", calc("A love for tradition has never weakened a nation, indeed it has strengthened nations in their hour of peril.    Sir Winston Churchill\n", 8));
